...
- On the same model, the paper's shape reached F1 25 and precision 34 at 385k tokens and 83 seconds per pull request; the general agent F1 12, precision 7, 5.7M tokens, 13 minutes; the authors' own benchmark and baseline.
- Anthropic reports under 1 percent of findings marked wrong at 15 to 25 dollars a pull request; Bugbot a dollar or two; vendor posts, self-reported, no shared benchmark.
