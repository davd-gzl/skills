# The body carries private names

A private repository's name reaches a public artifact through the target's own description, quoted by a finder into its candidate, and nothing between the finder and the commit reads the round against the list.
