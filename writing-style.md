...
- **Two rejections of one sentence end the guessing.** Offer three or four labelled variants, shortest first, and let the reader pick: a third rewrite in the same direction is the same miss again.
