...
- Anchor every link on words already in the prose, and link a named doc subsection to its header line. Never write a sentence whose only job is to carry a link; fold it into a sentence with content of its own.
