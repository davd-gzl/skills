...
6. **Bare adjectives.** Search for "sound", "correct", "safe", "fine", "nothing broken", and for every adjective of degree, "large", "slow", "many", "old". Replace each with the number, or with the check that was run and what it showed, or delete it.
